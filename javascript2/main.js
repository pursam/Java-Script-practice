 ...
 */
function defUpperStr(anyText) {
  return (anyText || 'DEFAULT TEXT').toUpperCase();
}
 ...
 *
 */
function mainFunc(first, second, callback) {
  var mass = [];
  if (typeof callback !== 'function') return false;
  return callback(first, second);
}
function func(a, b) { return mass = a + ' ' + b }
console.log(mainFunc('hello', 'world', func));
/*
